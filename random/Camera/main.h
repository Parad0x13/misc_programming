/*	Main header file, has buncho stuff in it.
	Like I said in Camera.cpp, I diddn't write
	this code, I am just using it from an online
	tutorial and I don't even claim to understand
	all of what is in it, but it will have to do
	untill I can program it myself. */
